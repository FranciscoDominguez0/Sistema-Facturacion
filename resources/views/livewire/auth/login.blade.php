    ...
    <div class="bg-white border border-slate-200 rounded p-8 w-full shadow-sm">
        ...
        <form wire:submit="login" class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-1.5">
                <div class="relative flex items-center bg-white border border-slate-300 focus-within:border-sovereign-blue focus-within:ring-1 focus-within:ring-sovereign-blue rounded transition-all @error('form.email') border-red-500 focus-within:border-red-500 focus-within:ring-red-500 @enderror">
            ...
            <div class="flex flex-col gap-1.5 mt-2">
                ...
                <div class="relative flex items-center bg-white border border-slate-300 focus-within:border-sovereign-blue focus-within:ring-1 focus-within:ring-sovereign-blue rounded transition-all @error('form.password') border-red-500 focus-within:border-red-500 focus-within:ring-red-500 @enderror" x-data="{ show: false }">
